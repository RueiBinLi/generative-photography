...
def run_inference(pipeline, tokenizer, text_encoder, base_scene, focal_length_list, output_dir, filename, device, video_length=5, height=256, width=384):
...
def main(config_path, base_scene, focal_length_list, filename):
    ...
    run_inference(pipeline, pipeline.tokenizer, pipeline.text_encoder, base_scene, focal_length_list, cfg.output_dir, filename, device=device)
...
if __name__ == "__main__":
    ...
    main(args.config, args.base_scene, args.focal_length_list, args.filename)
